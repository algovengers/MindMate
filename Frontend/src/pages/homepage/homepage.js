...
function Homepage() {
  ...
  return (
    <div className={styles.homepageContainer}>
      ...
      <footer className= {`${styles.footer} flex justify-center items-center $sm:py-16 py-6 flex-col`}>
      ...
      <div className="flex-[1] flex flex-col justify-start mr-10">
        ...
        />
        <p className="font-normal font-poppins text-dimWhite text-[18px] leading-[30.8px]mt-4 max-w-[312px]">
        Mental Health solved with AI
        </p>
      </div>
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
        Copyright Ⓒ 2024 MindMate. All Rights Reserved.
      </p>
