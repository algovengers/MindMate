    ...
    <div className={styles.homepageContainer}>
      <header>
        <div className={styles.logoContainer}>
          ...
          <div>
            ...
            <h6 className={`${styles.text} text-xs`}>A mental health chat assistance</h6>
          </div>
        </div>
      ...
      <main style={{minHeight:'100vh'}}>
        <section className={styles.leftSection}>
          <h1>
            Mental Health <br /> Solved with <span className={styles.ai}>AI</span>
          </h1>
          <div
      ...
      <section ref={about} className={`flex flex-col items-center gap-2 mb-4 ${styles.aboutUs}`} >
      ...
      <section className="mt-8">
        <h1 className="text-center text-4xl font-bold mb-8">Mental health Issues are Common</h1>
      ...
      <section className="mt-8" ref={articles}>
        ...
        <div className="xl:m-auto">
          <div className={styles.Articles}>
            <Articles title="Mental Health in the Workplace"
            ...
            <Articles title="How to Stop Negative Thoughts"
            ...
            <Articles title="What Is Imposter Syndrome?"
            ...
            <Articles title="The Negativity Bias"
